// ==Bookmarklet==
// @name 🔗
// @description New bookmark for the Library in personmeetup.ca
// @version 1.0
// ==/Bookmarklet==

// Following code was pulled from Nicolas Hoizey's bookmarklet:
// https://nicolas-hoizey.com/articles/2023/02/08/a-bookmarklet-to-create-a-new-link-content-markdown-on-github/
...
`;
    ...
    /* Build the URL
    /* *********************************************************************************/
		const filename = `src/library/${slug}.md`;

		let newFileUrl = `https://github.com/PersonMeetup/personmeetup-web/new/master/?filename=${filename}&value=${encodeURIComponent(
			value
